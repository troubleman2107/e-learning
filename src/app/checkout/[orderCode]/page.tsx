...
export default async function CheckoutPage({
  ...
  const qrUrl = `https://vietqr.app/img?bank=${bank}&acc=${bankAccount}&template=compact&showinfo=true&holder=${accountName}&amount=${order.amount}&addInfo=${order.orderCode}`;
